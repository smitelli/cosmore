...
/*****************************************************************************
 *                         COSMORE HEADER for MUSIC                          *
 *                                                                           *
 * This file contains a list of every music number available in the game,    *
 * whether or not the number is actually used in the code itself.            *
 *****************************************************************************/
